...
public class Constants {
    ...
    public static final float WORLD_TO_SCREEN = 32f; // 将1 meter转化为32 pixels

    // 定义重力加速度为-10m/s^2，接近现实世界（如果数值太夸张容易出bug)
    public static final Vector2 WORLD_GRAVITY = new Vector2(2, -10);
    ...
    // 图像地址用常量存储，学到了干货
    public static final String BACKGROUND_IMAGE_PATH = "assets/martianrun/background.png";
    public static final String GROUND_IMAGE_PATH = "assets/martianrun/ground.png";

    public static final String CHARACTERS_ATLAS_PATH = "assets/martianrun/characters.txt";
    public static final String[] RUNNER_RUNNING_REGION_NAMES = new String[]{"alienGreen_run1", "alienGreen_run2"};// 又一bug，写成Greeen
